          ...
          <View style={styles.roomNumbersContainer} className='z-9'>
            ...
            {(!isFiltered || (isFiltered && isCheckedOffice)) && (
              <>
                ...
                <RoomNumber top={52} left={2.3} number={"1800"} textSize={10} department="office"/>
                <RoomNumber top={62.9} left={7.8} number={"1102"} textSize={3.2} department="office"/>
                <RoomNumber top={64} left={39.3} number={"1110"} textSize={6} department="office"/>
                <RoomNumber top={58} left={39.5} number={"1113"} textSize={5.4} department="office"/>
                <RoomNumber top={51.4} left={55.2} number={"1206"} textSize={7} department="office"/>
                <RoomNumber top={49.9} left={93.8} number={"1328"} textSize={5} department="office"/>
                <RoomNumber top={40} left={93.9} number={"1412"} textSize={6}  department="office"/>
                <RoomNumber top={41.9} left={50.2} number={"1507"} textSize={6} department="office"/>
                <RoomNumber top={35.5} left={40.3} number={"1614"} textSize={7} department="office"/>
              </>
            )}
