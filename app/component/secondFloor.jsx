      ...
      <View className='w-full h-full'>
        ...
        >
          ...
          <View style={styles.roomNumbersContainer}>
            ...
            {/*2100s*/}
            <RoomNumber top={58.5} left={2.2} number={"2100"} textSize={4.5} />
            <RoomNumber top={52} left={5} number={"2101"} textSize={4.5} />
            <RoomNumber top={53.2} left={10.25} number={"2103"} textSize={4} />
            <RoomNumber top={53.5} left={14} number={"2105"} textSize={4.5} />
            <RoomNumber top={51.25} left={14} number={"2107"} textSize={4.5} />
            <RoomNumber top={57.2} left={26.5} number={"2110"} textSize={4.5} />
            <RoomNumber top={57.2} left={32.8} number={"2112"} textSize={4.5} />
            <RoomNumber top={50.5} left={29} number={"2113"} textSize={4.5} />
            <RoomNumber top={57.2} left={41.5} number={"2114"} textSize={4.5} />
            <RoomNumber top={57.2} left={49} number={"2116"} textSize={4.5} />
            <RoomNumber top={57.2} left={54} number={"2118"} textSize={4.5} />
            ...
            <RoomNumber top={53.8} left={67} number={"2122"} textSize={4.5} />
            <RoomNumber top={50.7} left={66.5} number={"2127"} textSize={4.5} />
            ...
            <RoomNumber top={39} left={56} number={"2215"} textSize={4.5} />
            <RoomNumber top={46} left={66.5} number={"2216"} textSize={4.5} />
            ...
            <RoomNumber top={46} left={94} number={"2226"} textSize={4.5} />
