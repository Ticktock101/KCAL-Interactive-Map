        ...
        >
          ...
          <View style={styles.roomNumbersContainer}>
            ...
            {(!isFiltered || (isFiltered && isCheckedOffice)) && (
              <>
                {/*und*/}
                <RoomNumber top={58.5} left={1.95} number={"2100"} textSize={5} department="office"/>
                <RoomNumber top={52.1} left={4.9} number={"2101"} textSize={5} department="office"/>
                <RoomNumber top={53.5} left={10.35} number={"2103"} textSize={3.5} department="office"/>
                <RoomNumber top={53.5} left={14} number={"2105"} textSize={4.5} department="office"/>
                <RoomNumber top={51.3} left={14} number={"2107"} textSize={4.5} department="office"/>
                <RoomNumber top={57.2} left={32.7} number={"2112"} textSize={5.5} department="office"/>
                <RoomNumber top={51.2} left={57} number={"2121"} textSize={3} department="office"/>
                <RoomNumber top={39} left={22.1} number={"2203"} textSize={4.5} department="office"/>
                <RoomNumber top={46} left={39.5} number={"2206"} textSize={2.7} department="office"/>
                <RoomNumber top={44.65} left={51.4} number={"2210"} textSize={4.5} department="office"/>
                <RoomNumber top={45.4} left={57.2} number={"2212"} textSize={4.5} department="office"/>
                <RoomNumber top={40.5} left={53.3} number={"2213"} textSize={3} department="office"/>
              </>
            )}
